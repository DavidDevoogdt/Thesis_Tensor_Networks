...
%%
 function [A,xi] = thermal_correlation_helper(MPO_matrix,O,N)
    ...
    for i = x_array
        ...
        c =1/(rho_left*rho_right*lambda^(i+1))* ncon( {rho_left,MPO_matrix,O,MPO_n,MPO_matrix,O,rho_right}, {  [-1,1], [1, 2,3,4],[3,2],[4,5], [5,6,7,8],[7,6],[8,-2]} );
