...
classdef PEPO
    ...
    methods
        ...
        function obj = makePEPO(obj)
            ...
            %obj.nf = trace(O_0000_unnormalised);
            
            obj.PEPO_cell{1,1,1,1} = reshape(  O_0000 , [d,d,1,1,1,1] ) ;
