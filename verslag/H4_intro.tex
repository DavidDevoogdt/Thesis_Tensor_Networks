...
\end{equation}
This Hamiltonian consists of 1 and 2 site operators. Of course more general Hamiltonians can also be used. The notation for the contraction of the \Gls{TN} will also be used to denote the Hamiltonian evaluated on the given geometry
\begin{alignat}{3}
...
\subsection{Idea}
This chapter shows the main construction of this dissertation. A cluster expansion is used to approximate $e^{ \hat{H} }$ for every possible geometry. The goal is to make a \Gls{MPO}/PEPO which captures the tensor exponential in the thermodynamic limit.
