...
\paragraph{discussion}
As can be expected from the construction, the bond dimension grows very fast. This type is just as precise as Type B, and will not be reported in the \cref{chap_bench}. This type could be improved by compressing the MPO at itermediate stages before adding a new primed level. This would likely not improve the speed and dimension of Type B. \todo{quantify}
