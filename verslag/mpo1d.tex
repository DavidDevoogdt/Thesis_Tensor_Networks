...
This thesis builds on the cluster expansions introduced in  \cite{Vanhecke2021}. The idea is to create tensor network with a number of virtual levels. The representation is exact up to M connected sites, where M is the order. Different variations are possible.
