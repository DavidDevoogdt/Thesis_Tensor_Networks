...
The implementation of the different \Gls{MPO} types can be found under \path{src_1D/generateMPO.m}. It bundles some helper functions such as contracting a chain or cycle of  \Glspl{MPO} or construction of an exponentiated Hamiltonian for the given input Hamiltonian. Another example is constructing the inverse by sequential inverse \Gls{MPO} contraction, ...
...
One external package is not checked in on git: MatlabTrack. This is used in  \verb#src_2D/process_PEPO/PEPO_vumps.m# to calculate the \Gls{VUMPS} environment. This proprietary code was written by the QuantumGroup@UGent. To obtain the code, go to \path{https://quantumghent.github.io/software/}
