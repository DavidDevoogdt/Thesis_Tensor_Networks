...
The non-linear solver is at the moment only the fastest for small highly non-linear problems, such as solving \cref{tikzfig:plaquetter} in a rotation invariant manner. The non-linear solver can optimise multiple problems at once, and could be extended to fully use internal symmetries of the model.
